...
#ifndef MIRTK_CubicBSplineInterpolateImageFunction2D_HXX
#define MIRTK_CubicBSplineInterpolateImageFunction2D_HXX
...
GenericCubicBSplineInterpolateImageFunction2D<TImage>
...
// -----------------------------------------------------------------------------
template <class TImage>
inline typename GenericCubicBSplineInterpolateImageFunction2D<TImage>::VoxelType
GenericCubicBSplineInterpolateImageFunction2D<TImage>
...
::GetOutside(double x, double y, double z, double t) const
{
  if (this->_InfiniteCoefficient) {
    return type_cast<VoxelType>(Get(this->_InfiniteCoefficient, x, y, z, t));
  } else {
    return Get(x, y, z, t);
  }
}
...
{
  return type_cast<VoxelType>(GetWithPadding(this->Input(), &this->_Coefficient, x, y, z, t));
}
...
::GetWithPaddingOutside(double x, double y, double z, double t) const
{
  if (this->Extrapolator() && this->_InfiniteCoefficient) {
    return type_cast<VoxelType>(GetWithPadding(this->Extrapolator(), this->_InfiniteCoefficient, x, y, z, t));
  } else {
...
#endif // MIRTK_CubicBSplineInterpolateImageFunction2D_HXX 
